...
$(document).ready(function(e){
	...
	function showPan(e)
	{
		$("#struct_head").animate({top:"-100px"},"fast");
		$("#struct_sheet").animate({top:zs_screenHeight},"fast",function(){$("#hideButton").css("top",zs_screenHeight-20);});
	}
